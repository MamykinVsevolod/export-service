...
ExportService - это независимый микросервис, который получает готовые данные из базы после завершенной парсинг-сессии и предоставляет возможность экспортировать их в различных форматах.
